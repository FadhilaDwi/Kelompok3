<?php 
	...
	class loginmitra extends Ci_Controller{
		...
		public function aksi_login(){
			...
			$cek = $this->login->cek_login("mitra", $where)->num_rows(); //melakukan cek tabel user berdasarkan id
			...
			if($cek > 0){
				...
				redirect(base_url('customer/dashboardmitra'));
		...
		function logout(){
			...
			redirect(base_url('loginmitra')); // pindah ke halaman login
		}
