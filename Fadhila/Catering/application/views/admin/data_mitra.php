<div class="container-fluid">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td ><?php echo anchor ('admin/edit/'.$b->id_mitra, '<div class="btn btn-primary btn-sm"> <i class="fas fa-edit"></i> </div>') ?></td>

            <td><?php echo anchor ('admin/data_hewan/hapus/' .$b->id_mitra, '<div class="btn btn-danger  btn-sm"> <i class="fas fa-trash"></i></div>') ?></td>
        </tr>
...
<div class="modal fade" id="edit_mitra" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url(). 'admin/data_mitra/update' ?>" method="post" enctype="multipart/form-data" >
            
                <div class="form-group">
                    <label>Id Mitra</label>
                    <input type="text" class="form-control" id="idmitra" name="id_mitra" value="<?php echo $hwn->jenis_hewan ?>"  readonly>
                </div>
                <div class="form-group">
                    <label>Nama Usaha</label>
                    <input type="text" name="nama_katering" class="form-control" >
