<center><a href="<?= base_url('dashboardpelanggan/index')?>"><button class="add btn btn-success mt-2">Beli Lagi</button></a></center>
<?= form_open_multipart('dashboardpelanggan/beli')?>
            ...
            <div class="container">
                <div class="card mt-1" style="width: 31rem;">
                    <div class="card-body">
                        ...
                        <?php }else if(($pesanan['status_pesanan']) == 'sedang proses'){ ?>
                        <h6 class="transaksi-sukses">Sedang Proses</h6>
