...
function __construct(){
		...
		$this->load->model('model_mitra'); //untuk menjalankan perintah yang ada pada mdata
    ...
    {
        $data['kodeunik'] = $this->model_mitra->buat_kode(); // variable $kodeunik merujuk ke file model_user.php pada function buat_kode. paham kan ya? harus paham dong
    $data['mitra'] = $this->model_mitra->tmpmitra()->result();   
